...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">
   <style>
        .bg-image {
            background-image: url('assets/img/biru (2).jpg');
            height: 100vh;
        }
    </style>
</head>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-botton">
 <p>&copy; UKK RPL 2024 I Orvi kristiani</p>
</footer>
